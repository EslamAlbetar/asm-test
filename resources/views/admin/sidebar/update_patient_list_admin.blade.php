        ...
        <div class="page-header">
            <div class="container-fluid">
                ...
                <div class="form-container">
                    <form action="{{url('edit_patient_list_admin', $data->id)}}" method="post" enctype="multipart/form-data" class="patient-form">
                        @csrf
                        ...
                        <div class="form-actions">
                            ...
                            <a class="btn btn-danger" onclick="confirmation(event)" href="{{url('delete_patient_admin', $data->id)}}">Delete</a>
                            <a class="btn btn-warning" href="{{url('total_patients_admin')}}">Back</a>
                        </div>
                    </form>
                </div>
            </div>
